...
import { ProductOpacity } from '../common/ingestion-manager/ingestion-manager.interface';
...
export class IngestionRasterData {
  ...
  @Field((type) => ProductOpacity, { nullable: false })
  public productOpacity: ProductOpacity;
